...
On August 2, 2024, the FATES-MLOps project was awarded €600,000 by the _Agence Nationale de la Recherche_ (ANR) to work on _Incorporating FATES Principles in Continuous Development of ML-Integrated Systems_
{: .text-justify }

The key issue of thje project is: **"Can we systematically and progressively include justifications related to the FATES (_Fairness, Accountability, Transparency, Ethics, and Security_) building and operating of a software system integrating Machine Learning?**"
{: .text-justify }
...
- Institut de Recherche en Informatique de Toulouse ([IRIT](https://www.irit.fr/en/home/))
  - Jean-Michel Bruel
  - Olivier Teste
  - Marc Pantel
- Laboratoire d'Informatique, Signaux et Systèmes de Sophia Antipolis ([I3S](https://www.i3s.unice.fr/))
  - Mireille Blay-Fornarino
  - Philippe Collet
- Institut National de la Recherche en Sciences et Technologies du Numérique ([Inria](https://inria.fr/fr))
  - Fréderic Precioso
  - Michel Riveill
