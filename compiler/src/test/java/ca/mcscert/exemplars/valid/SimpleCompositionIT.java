...
@DisplayName("Source file: src/test/resources/valid/simpleComposition.jd")
public class SimpleCompositionIT extends SourceFileTest {

    @Override
    protected String source() { return "valid/simpleComposition.jd";}
