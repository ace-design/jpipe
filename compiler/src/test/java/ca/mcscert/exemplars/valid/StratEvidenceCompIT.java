...
@DisplayName("Source file: src/test/resources/valid/stratEvidenceComp.jd")
public class StratEvidenceCompIT extends SourceFileTest {
    @Override
    protected String source() { return "valid/stratEvidenceComp.jd";}
    ...
    class compositionTest {
        ...
        public void elementsAreCorrectlySupported() {
            ...
            assertEquals(Set.of("sc1","sc2"), asIdentifiers(j.get("AND1").getSupports()));
