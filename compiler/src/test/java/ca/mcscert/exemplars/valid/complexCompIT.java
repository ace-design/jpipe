...
@DisplayName("Source file: src/test/resources/valid/complexComp.jd")
public class complexCompIT extends SourceFileTest {
    @Override
    protected String source() { return "valid/complexComp.jd";}
