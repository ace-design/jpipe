...
@DisplayName("Source file: src/test/resources/valid/multipleMerge.jd")
public class multipleMergeIT extends SourceFileTest {

    @Override
    protected String source() { return "valid/multipleMerge.jd";}
    ...
    class compositionTest {
        ...
        public void elementsHaveTheRightType() {
            ...
            assertInstanceOf(SubConclusion.class,j.get("j:sc3"));
            ...
            assertInstanceOf(Evidence.class, j.get("j:e4"));
        }
        ...
        public void elementsAreCorrectlySupported() {
            ...
            assertEquals(Set.of("e1", "e4"), asIdentifiers(j.get("s2").getSupports()));
            assertEquals(Set.of(), asIdentifiers(j.get("e1").getSupports()));
            assertEquals(Set.of(), asIdentifiers(j.get("e4").getSupports()));
        }
