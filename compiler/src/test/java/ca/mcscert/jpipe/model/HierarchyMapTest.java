...
public class HierarchyMapTest {
    ...
    private HierarchyMap<JustificationElement> table;
    private Evidence e1;
    private Evidence e2;
    private Evidence e3;
    ...
    public void findParentValue(){
        JustificationElement parent_element_e1 = table.getDirectParent(e1);
    ...
    public void deletingElement(){
        ...
        assertNull(table.getDirectParent(e2));
    }
